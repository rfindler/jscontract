/*=====================================================================*/
/*    serrano/prgm/project/hop/work/contract/benchs/abbrev.js          */
/*    -------------------------------------------------------------    */
/*    Author      :  Manuel Serrano                                    */
/*    Creation    :  Thu May 16 08:58:06 2019                          */
/*    Last change :  Fri Jul 12 12:37:32 2019 (serrano)                */
	 ...
	 return new CTWrapper( function( value ) {
	    if( typeof value === "function" ) {
		  ...
		  apply: function( target, self, args ) {
		     switch( args.length ) {
			case 0:
		     	   return ri.box( call.call( value, this, undefined ) );
			case 1:
		     	   return ri.box( call.call( value, this, dis[ 0 ].box( args[ 0 ] ) ) );
			default: 
		     	   return ri.box( apply.call( value, this, map2( args, dis, info ) ) );
		     }
		  },
		  toString: function() {
